(function () {
  ...
  function showBanner() {
    var css = [
      ...
      '#cookie-consent-banner .ccb-text a { color: #0D9488; text-underline-offset: 3px; }',
      ...
      '}',
      '#cookie-consent-banner .ccb-accept:hover { background: #0f766e; }',
      ...
      '}',
      '#cookie-consent-banner .ccb-decline:hover { border-color: #0D9488; color: #0D9488; }',
